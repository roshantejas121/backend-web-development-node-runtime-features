...
// fs.readFile holds the entire file in memory before the application can use it,
// so the memory required grows with the file size. A stream moves the file in
// small chunks, keeping peak memory nearly flat even when the file is very large.
